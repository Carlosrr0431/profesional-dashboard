/**
 * Métricas responsive para passenger-app.
...
export function createResponsiveMetrics(width, height) {
  ...
  return {
    ...
    /** Ratios de sheet adaptados a orientación. */
    sheetRatios: isLandscape || isCompactHeight
      ? { browse: 0.92, confirmationMin: 0.88, absoluteMin: 0.42 }
      : { browse: 0.84, confirmationMin: 0.78, absoluteMin: 0.32 },
  };
}
