/**
 * Mapa de rutas del main navigator (passenger-app).
 * Actualizá solo este archivo al agregar, renombrar o quitar pantallas.
...
export const MAIN_ROOT_ROUTE_NAMES = NAVIGATION_STRUCTURE.stack;
