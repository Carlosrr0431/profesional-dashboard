-- Push pasajeros: tabla de tokens FCM + trigger trip.transition.
-- Ejecutar TODO este archivo en el editor SQL de Supabase (una sola vez).
-- Equivalente a passenger_devices.sql + whatsapp_trip_transition_event.sql.
...
-- ============================================================
-- 2. Trigger HTTP → Agente_IA en cambios de estado del viaje
-- ============================================================
