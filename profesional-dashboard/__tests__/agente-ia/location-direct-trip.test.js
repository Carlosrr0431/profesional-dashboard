 ...
 *
 * Regresion: si llega ubicación actual (pin GPS) por WhatsApp,
...
describe('messages.upsert location -> viaje directo', () => {
  it('crea viaje con pickup GPS aun sin placeholder wa_context en trips', async () => {
    ...
    expect(capturedTripInsert.origin_address).toContain('Cherin');
    expect(capturedTripInsert.origin_lat).toBeCloseTo(-24.7945667);
    expect(capturedTripInsert.origin_lng).toBeCloseTo(-65.3766708);
