...
function LineCard({ lineData, onRefresh }) {
  ...
  const lineNames = {
    1: { name: 'Línea Pasajeros', icon: '🧳', desc: 'OTP y comunicaciones de la app de pasajeros' },
        ...
        {!loading && (
          <div className="mt-10 bg-[#0f1729]/60 border border-white/5 rounded-2xl p-5">
            ...
            <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
              <div>
                <p className="text-gray-500 text-[10px] font-bold uppercase tracking-wider mb-2">Línea 1 — Pasajeros</p>
