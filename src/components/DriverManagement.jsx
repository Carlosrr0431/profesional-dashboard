              ...
              <table className="w-full min-w-[560px] lg:min-w-0">
                <thead>
                  <tr className="border-b border-slate-200/60 bg-slate-50/80">
                    ...
                    <th className="hidden text-left px-4 py-3.5 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em] md:table-cell">Contacto</th>
                    <th className="hidden text-left px-4 py-3.5 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em] lg:table-cell">Vehículo</th>
                    <th className="text-center px-4 py-3.5 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em]">Viajes</th>
                    <th className="text-center px-4 py-3.5 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em]">Calificación</th>
            ...
            <table className="w-full min-w-[560px] lg:min-w-0">
              <thead>
                <tr className="border-b border-light-300/50">
                  ...
                  <th className="hidden text-left px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em] md:table-cell">Contacto</th>
                  <th className="hidden text-left px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em] lg:table-cell">Vehículo</th>
                  <th className="text-center px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em]">Viajes</th>
                  <th className="text-center px-4 py-3 text-[11px] font-semibold text-slate-500 uppercase tracking-[0.06em]">Calificación</th>
    ...
    >
      ...
      <td className="px-4 py-3 text-center">
        <div className="flex justify-center">
          <DriverRatingChip driver={driver} />
        </div>
      </td>
