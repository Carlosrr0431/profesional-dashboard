      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 30 }} showsVerticalScrollIndicator={false}>
        ...
        <View style={{ height: 230 }}>
          ...
          >
            {trip.origin_lat && (
              <Marker
                coordinate={{ latitude: Number(trip.origin_lat), longitude: Number(trip.origin_lng) }}
                anchor={{ x: 0.5, y: 0.5 }}
            ...
            {trip.destination_lat && (
              <Marker
                coordinate={{ latitude: Number(trip.destination_lat), longitude: Number(trip.destination_lng) }}
                anchor={{ x: 0.5, y: 0.5 }}
                tracksViewChanges={false}
              >
                <View style={{
