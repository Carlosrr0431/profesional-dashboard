...
/** Marca el punto final de la ruta activa. Se renderiza dentro de MapLibreGL.MarkerView. */
const RouteEndMarker = React.memo(({ variant = 'destination' }) => {
...
const styles = StyleSheet.create({
  ...
  pinRound: { borderRadius: 11 },
  pinSquare: { borderRadius: 5 },
  corePickup: {
    width: 10, height: 10,
    borderRadius: 5, backgroundColor: colors.success,
  },
  coreDest: {
    width: 10, height: 10,
